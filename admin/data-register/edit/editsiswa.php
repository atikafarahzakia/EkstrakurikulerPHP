...
$siswa = datasiswa("SELECT * FROM register_siswa WHERE id_siswa= $id")[0];
// cek apakah tombol simpan ditekan akan bertambah
if (isset($_POST['ubah'])) {
    if (edit_regissiswa($_POST) > 0) {
        echo "<script>
            ...
            <div class="">
                <form action="" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="formGroupExampleInput" name="nama" value="<?= $siswa['nama_siswa']; ?>">
                    </div>
                    <div class="mb-3">
                        <label for="formGroupExampleInput" class="form-label">NISN</label>
                        <input type="text" class="form-control" id="formGroupExampleInput" name="nisn" value="<?= $siswa['nisn']; ?>">
                    </div>
                    <div class="mb-3">
                        <label for="formGroupExampleInput" class="form-label">Kelas</label><br>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="kelas" id="inlineRadio1" value="X" value="<?= $siswa['kelas']; ?>">
                            <label class="form-check-label" for="inlineRadio1">X</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="kelas" id="inlineRadio2" value="XI" value="<?= $siswa['kelas']; ?>">
                            <label class="form-check-label" for="inlineRadio2">XI</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="kelas" id="inlineRadio2" value="XII" value="<?= $siswa['kelas']; ?>">
                            <label class="form-check-label" for="inlineRadio2">XII</label>
                        </div>
                    </div>
                    <div class="mb-3">
                        <label for="formGroupExampleInput" class="form-label">Jurusan</label>
                        <select class="form-select mb-3" name="jurusan" required value="<?= $siswa['jurusan']; ?>">
